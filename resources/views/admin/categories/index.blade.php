                                ...
                                <div class="table-responsive table-card mb-3">
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="owner" scope="col">Events</th>
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td class="owner"><a href="{{url('admin/events/'.$category->id.'/index')}}"> ({{ $category->events->count() }})</a></td>
                                                <td>
                                            ...
                                            <div class="modal-body">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div>
                                                            <label for="name"
                                                                   class="form-label">Service Icon</label>
