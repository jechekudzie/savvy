                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <button class="btn btn-info add-btn" data-bs-toggle="modal"
                                            ...
                                            class="ri-add-fill me-1 align-bottom"></i> Add Currency
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive table-card mb-3">
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="owner" scope="col">Currency</th>
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/currencies/'.$currency->id.'/edit')}}">Edit <i
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        ...
                                        <form method="post" action="{{url('/admin/currencies')}}"
