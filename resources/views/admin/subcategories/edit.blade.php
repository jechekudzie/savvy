            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{$subcategory->name}}</h4>
            ...
            <div class="row">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <a href="{{url('/admin/subcategories/'.$subcategory->category->id.'/index')}}" class="btn btn-info add-btn"><i
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="name" class="form-control rounded-pill" value="{{ $subcategory->name }}">
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="description" class="editor form-control rounded-pill" placeholder="Enter subcategory description">{{ $subcategory->description }}</textarea>
                                                        </div>
                                                        <div class="mb-3">
                ...
                <div class="col-xxl-3">
                    <div class="card" id="company-view-detail">
                        ...
                        <div class="card-body">
                            <h6 class="text-muted text-uppercase fw-semibold mb-3">Category cover</h6>
                            <img width="500" class="img-fluid" src="{{asset($subcategory->image)}}"/>
                        </div>
                    </div>
                    <!--end card-->
                    ...
                    <div class="card" id="company-view-detail">
                        ...
                        <div class="card-body">
                            <h6 class="text-muted text-uppercase fw-semibold mb-3">Category banner</h6>
                            <img width="500" class="img-fluid" src="{{asset($subcategory->image)}}"/>
                        </div>
                    </div>
                </div>
