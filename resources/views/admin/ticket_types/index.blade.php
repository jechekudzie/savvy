            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Ticket Types</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                                <li class="breadcrumb-item active">ticket_types</li>
                            </ol>
                        </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="flex-grow-1">
                                    <button class="btn btn-info add-btn" data-bs-toggle="modal"
                                            ...
                                            class="ri-add-fill me-1 align-bottom"></i> Add Ticket Type
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive table-card mb-3">
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="owner" scope="col">Ticket Tyoe</th>
                                            <th class="sort" data-sort="owner" scope="col">Description</th>
                                            <th scope="col">Action</th>
                                        </tr>
                                        </thead>
                                        <tbody class="list form-check-all">
                                        @foreach($ticket_types as $event_type)
                                            <tr>
                                                <td scope="row">
                                                    <div class="form-check">
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="edit-item-btn"
                                                               href="{{url('/admin/ticket_types/'.$event_type->id.'/edit')}}">Edit <i
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        ...
                                        <form method="post" action="{{url('/admin/ticket_types')}}"
